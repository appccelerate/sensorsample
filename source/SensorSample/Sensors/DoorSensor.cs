    ...
    public class DoorSensor : ISensor, IInitializable
    {
        ...
        public void Initialize()
        {
            ...
            this.stateMachine
                ...
                .On(Events.DoorClosed).Goto(States.DoorClosedInNormalMode)
                    .Execute(this.DetermineTargetLevel)
                    .Execute(this.LogDoorClosedInNormalMode);
            ...
            this.stateMachine
                ...
                .On(Events.DoorClosed).Goto(States.DoorClosedInPanicMode)
                    .Execute(this.DetermineTargetLevel)
                    .Execute(this.LogDoorClosedInPanicMode);
